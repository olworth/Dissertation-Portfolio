...
# Initialise the list of POS tags to be used by the model
label_list = catalan_raw['train'].features[f"upos"].feature.names
label_list_gal = galician_split['train'].features[f"upos"].feature.names
...
es_training_args = TrainingArguments(
    ...
    save_strategy="epoch",
    # Loads best weights checkpoint, based on F1 score
...
es_trainer = Trainer(
    ...
    train_dataset=tokenized_catalan_es["train"],
    eval_dataset=tokenized_catalan_es["validation"],
