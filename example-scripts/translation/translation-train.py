...
es_checkpoint = 'homersimpson/subsec-t5-spanish-30k'
...
es_training_args = Seq2SeqTrainingArguments(
    output_dir="translation/es",
...
es_trainer = Seq2SeqTrainer(
    ...
    train_dataset=tokenized_es["train"],
    eval_dataset=tokenized_es["validation"],
