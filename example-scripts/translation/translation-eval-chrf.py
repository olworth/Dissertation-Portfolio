...
# Load evaluation metric - in this case chrF++
import evaluate
...
# Define the evaluation function, here calculating the chrF++ score of the model's predictions, also returns average generation length
